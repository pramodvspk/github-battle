...
/***/ function(module, exports, __webpack_require__) {
	...
	UserDetails.PropTypes = {
	  ...
	  info: PropTypes.shape({
	    ...
	    public_repos: PropTypes.number.isRequire
	  })
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function calculateScores(players) {
	  return [players[0].followers * 3 + players[0].totalStars * 1, players[1].followers * 3 + players[1].totalStars * 1];
	}
	...
	var helpers = {
	  ...
	  battle: function battle(players) {
	    ...
	    return axios.all([playerOneData, playerTwoData]).then(calculateScores).catch(function (err) {
	      console.warn('Hey there is an error while calculating scores');
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsContainer = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(Results, { isLoading: this.state.isLoading, scores: this.state.scores, playersInfo: this.props.location.state.playersInfo });
	  }
	});
